    ...
    <section className="portfolio">
      ...
      <ul className="portfolio__list">
        <li className="portfolio__paragraph">
          <a className="portfolio__link portfolio__link-border" href="https://github.com/Masha-Muraveva/how-to-learn" rel="noreferrer" target="_blank">
          <p className="portfolio__text">Статичный сайт</p>
          <img className="portfolio__icon" src={followingIcon} alt="Стрелка для перехода на Статичный сайт" />
          </a>
        </li>
        <li className="portfolio__paragraph">
          <a className="portfolio__link portfolio__link-border" href="https://github.com/Masha-Muraveva/russian-travel" rel="noreferrer" target="_blank">
